        ...
        if(mAuth.getCurrentUser() != null) {
            ...
            addPostBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent newPostIntent = new Intent(MainActivity2.this, NewPostActivity.class);
            ...
            firebaseFirestore.collection("Users").document(current_user_id).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(MainActivity2.this, "Error : " + errorMessage, Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_settings_btn:
                ...
                Intent settingsIntent = new Intent(MainActivity2.this, SetupActivity.class);
